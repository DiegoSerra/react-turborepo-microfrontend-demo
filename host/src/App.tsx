...
import { RemoteManager } from "./remotes/RemoteManager";
import { Remote, Remote2, Remote2Counter } from "./remotes/remotes";
      ...
      <DisabledContext.Provider value={false}>
        ...
        <div className="host">
          <div className="card">
            ...
            <div className="title">I'm the host app {isDesktop ? 'on desktop' : 'on mobile'}</div>
            <Counter />
            <Button>shared ui from host</Button>
          </div>
        </div>
